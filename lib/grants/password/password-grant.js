...
const logger = createClientLogger('tokenHandler:passwordGrant')
...
class PasswordGrant extends AbstractGrant {
  ...
  async validateUser(accessTokenRequest) {
    logger.info('validateUser: ', accessTokenRequest.credentials.username)
  ...
  async createToken(client, user, accessTokenRequest) {
    logger.info('createToken: ', accessTokenRequest.scope)
