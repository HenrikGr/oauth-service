...
const logger = createClientLogger('authorizeHandler:tokenResponse:implicitGrant')
...
class ImplicitGrant {
  ...
  async createAccessToken(client) {
    logger.info('createAccessToken', client.name)
    ...
    return await this.model.saveToken(client, this.user, token)
  }
