...
const logger = createClientLogger('tokenHandler:refreshTokenGrant')
...
class RefreshTokenGrant extends AbstractGrant {
  ...
  async validateRefreshToken(accessTokenRequest, client) {
    logger.info('validateRefreshToken: ', accessTokenRequest.refreshToken)
  ...
  async deleteRefreshToken(token) {
    logger.info('deleteRefreshToken: ', token.refreshToken)
