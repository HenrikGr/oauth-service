...
const { log, error } = require('@hgc-ab/debug-service')('oauth:tokenHandler:refreshTokenGrant')
...
class RefreshTokenGrant extends AbstractGrant {
  ...
  async validateRefreshToken(accessTokenRequest, client) {
    log('validateRefreshToken: ', accessTokenRequest.refreshToken)
  ...
  async deleteRefreshToken(token) {
    log('deleteRefreshToken: ', token.refreshToken)
