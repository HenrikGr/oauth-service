...
const { log, error } = require('@hgc-ab/debug-service')('oauth:authenticateHandler')
...
class AuthenticateHandler {
  ...
  async validateAccessToken(authenticateRequest) {
    log('validateAccessToken:', authenticateRequest.token)
    const now = new Date()
  ...
  async verifyAccessTokenScope(accessToken) {
    log('verifyAccessTokenScope:', accessToken.scope, this.scope)
