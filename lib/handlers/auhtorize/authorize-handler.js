...
const { log, error } = require('@hgc-ab/debug-service')('oauth:authorizeHandler')
...
class AuthorizeHandler {
  ...
  async validateClient(authorizationRequest) {
    log('validateClient:', authorizationRequest.clientId)
  ...
  async validateScope(client, user, authorizationRequest) {
    log('validateScope:', authorizationRequest.scope)
